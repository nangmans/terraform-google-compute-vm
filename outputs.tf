...
output "template" {
  ...
  value       = try(google_compute_instance_template.instance_template.0, null)
}

output "template_name" {
  description = "Template name."
  value       = try(google_compute_instance_template.instance_template.0.name, null)
}

...
- simple_example Designated Directory에는 아래 작업이 구현되어 있습니다.
  ...
  - Boot Disk 생성시 Image 옵션을 사용
     - OS Image Ubuntu 20.04 LTS
     - Persistent SSD Type
  - Scheduling Options(STOP),Provisioning Model(STANDARD) 설정 되어 있음
  - macine type은 e2-micro로 설정 되어 있음
  - VM Sheild Booting Option 설정 되어 있음
